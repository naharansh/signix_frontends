...
import { employee_applicationss, Employee_recordsss } from '../../../../../utils/iconmap'
export const  My_DA_Reimbursements=()=>{
       const mainmenu=data.switchMenu.find(m=>m.id ==='hrm').menus
        ...
        const subsubmenu=submenu.find(ssm=>ssm.id==='submenu-two').subsubmenu.find((subsubmenu)=>subsubmenu.id==='subsubmenu-one').subsubsubmenu
...
export const Team_DA_Reimbursements=()=>{
    const mainmenu=data.switchMenu.find(m=>m.id ==='hrm').menus
...
export const All_DA_Reimbursements=()=>{
    const mainmenu=data.switchMenu.find(m=>m.id ==='hrm').menus
