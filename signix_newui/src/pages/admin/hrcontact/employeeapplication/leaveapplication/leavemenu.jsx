...
export const  My_Applications=()=>{
       const mainmenu=data.switchMenu.find(m=>m.id ==='hrm').menus
        ...
        const subsubmenu=submenu.find(ssm=>ssm.id==='submenu-three').subsubmenu.find((subsubmenu)=>subsubmenu.id==='subsubmenu-one').subsubsubmenu
        // console.log()
...
export const Team_Applications=()=>{
    const mainmenu=data.switchMenu.find(m=>m.id ==='hrm').menus
        ...
        const subsubmenu=submenu.find(ssm=>ssm.id==='submenu-three').subsubmenu.find((subsubmenu)=>subsubmenu.id==='subsubmenu-two').subsubsubmenu
        const navigate=useNavigate()
...
export const All_Applications=()=>{
    const mainmenu=data.switchMenu.find(m=>m.id ==='hrm').menus
        ...
        const subsubmenu=submenu.find(ssm=>ssm.id==='submenu-three').subsubmenu.find((subsubmenu)=>subsubmenu.id==='subsubmenu-three').subsubsubmenu  
         return (
            <>
              <div className="my-10 mx-5 grid grid-cols-1 gap-6 justify-center lg:grid-cols-4 md:grid-cols-3">
                       {subsubmenu.length > 0 ? (
