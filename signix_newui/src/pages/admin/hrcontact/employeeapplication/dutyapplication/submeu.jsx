...
export const  My_OnDuty_Applications=()=>{
       const mainmenu=data.switchMenu.find(m=>m.id ==='hrm').menus
        ...
        const subsubmenu=submenu.find(ssm=>ssm.id==='submenu-four').subsubmenu.find((subsubmenu)=>subsubmenu.id==='subsubmenu-one').subsubsubmenu
        // console.log()
...
export const Team_OnDuty_Applications=()=>{
    const mainmenu=data.switchMenu.find(m=>m.id ==='hrm').menus
        ...
        const subsubmenu=submenu.find(ssm=>ssm.id==='submenu-four').subsubmenu.find((subsubmenu)=>subsubmenu.id==='subsubmenu-two').subsubsubmenu
        const navigate=useNavigate()
...
export const All_OnDuty_Applications=()=>{
    const mainmenu=data.switchMenu.find(m=>m.id ==='hrm').menus
