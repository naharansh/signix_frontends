...
export const SubSubMenus=()=>{
    const first_stage_menu=data.switchMenu.find((mid)=>mid.id === 'finance').menus?.find((sid)=>sid.id === 'record-sixth').subMenus?.find((submid)=>submid.id === 'assets-one').subsubmenus||[]
    console.log(first_stage_menu.subsubmenus)
