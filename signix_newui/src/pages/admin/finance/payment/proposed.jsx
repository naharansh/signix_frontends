          ...
          <CardContent>
            <div className="grid grid-cols-2 mb-5">
              <div className="flex flex-col mx-4 ">
                <Label className="mb-2">Paid By</Label>
              ...
              <div className="flex flex-col mx-4 ">
                <Label className="mb-2">Paid From (Cr.)</Label>
                <Select placeholder="Select Bill to">
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Theme" />
                  </SelectTrigger>
                ...
                <TableBody>
                  {items.map((item, index) => (
                    <TableRow key={item.id}>
                      <TableCell className="border border-gray-300 text-center px-3 py-2 w-10">
                        {index + 1}
                      </TableCell>
...
export const Proposed_Payment_list =()=>{
  const data = [];
