...
export const Proposed_payments_menus=()=>{
    const first_stage_menu=data.switchMenu.find((mid)=>mid.id === 'finance').menus?.find((sid)=>sid.id === 'record-one').subMenus?.find((submid)=>submid.id === 'submenu-fourth').subsubmeus?.find((nextid)=>nextid.id === 'subsubmenu-three').subsubsubmenu||[]
