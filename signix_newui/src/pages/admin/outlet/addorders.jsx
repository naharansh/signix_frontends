...
export const Addorders = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    item_id: item.item_id,
      ...
      const response = await axios.post(
        "http://localhost:8080/api/orderitems/create",
        payload,
        {
 ...
 const handleProductSelect = (rowId, productId) => {
  const selectedProduct = customer.find(
...
const discountamount = items.reduce((total, item) => {
  ...
  <div className="bg-white p-4 rounded shadow w-full mx-4 md:w-80 md:mx-0">
    ...
    <div className="flex justify-between font-bold text-lg">
      <span>Total</span>
      <span>₹ {(totalTaxableValues -discountamount).toFixed(2)}</span>
    </div>
          ...
          <Card className="shadow-md rounded-none mx-5 border border-gray-200 my-4">
            <CardContent>
              ...
              <div className="grid grid-cols-1 gap-2 my-4 md:grid-cols-3">
